        ...
        public static void SetearFila(DataGridViewRow r, object obj)
        {
            switch (obj)
            {
                ...
                case Producto producto:
                    ...
                    break;
                case ComprasDto compras:
                    r.Cells[0].Value = compras.CompraId;
                    r.Cells[1].Value = compras.FechaCompra;
                    r.Cells[2].Value = compras.proveedor;
                    r.Cells[3].Value = compras.Total;
                    break;
